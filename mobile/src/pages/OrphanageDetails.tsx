...
export default function OrphanageDetails() {
    ...
    useEffect(() => {
        api.get(`orphanage/${id}`).then(reponse => {
            setOrphanage(reponse.data)
        })
    }, [id]) // colocar todas as varias que são usadas dentro do effect como dependencia
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.description}>
                    Carregando . . . { /*  react-native-shimmer -> da um efeito parecido com skeleton screen  */}
                </Text>
            </View>
        );
    }
